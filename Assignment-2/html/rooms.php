                            ...
                            ?>
                                ...
                                <div class="room-content">
                                    ...
                                    <div class="card-btn">
                                        ...
                                        {
                                            ?>
                                            <button class="book-btn" onclick="checkRoomAvailability('card_avail_<?php echo $i; ?>')"><a style="text-decoration: none !important; color: white;" href="payment.php">BOOK NOW</a></button>
                                            <?php
                                        }
                                        ?>
                                    </div>
